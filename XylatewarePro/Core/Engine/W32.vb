...
#Region " Pinvoke "
        ...
        <DllImport("user32.dll")>
        Public Shared Function RedrawWindow(ByVal hWnd As IntPtr, <[In]> ByRef lprcUpdate As RECT, ByVal hrgnUpdate As IntPtr, ByVal flags As RedrawWindowFlags) As Boolean
        End Function
...
#Region " Structures "
        ...
        Public Structure RECT
            ...
            Public Sub New(ByVal r As System.Drawing.Rectangle)
            ...
            Public Shared Widening Operator CType(ByVal r As RECT) As Drawing.Rectangle
                Return New Drawing.Rectangle(r.Left, r.Top, r.Width, r.Height)
            End Operator

            Public Shared Widening Operator CType(ByVal r As Drawing.Rectangle) As RECT
                Return New RECT(r)
            End Operator
            ...
            Public Overrides Function GetHashCode() As Integer
                Return (CType(Me, System.Drawing.Rectangle)).GetHashCode()
            End Function
