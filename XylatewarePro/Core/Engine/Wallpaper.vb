...
Namespace Core.Engine
    Public Class Wallpaper
        ...
        Public Shared Sub SetDesktopWallpaper(ByVal path As String, ByVal style As WallpaperStyle)
            ...
            If ((Not ext.Equals(".bmp", StringComparison.OrdinalIgnoreCase) AndAlso
                 Not ext.Equals(".jpg", StringComparison.OrdinalIgnoreCase)) _
                OrElse
                (ext.Equals(".jpg", StringComparison.OrdinalIgnoreCase) AndAlso
        ...
        ByVal uiAction As UInt32,
        ByVal uiParam As UInt32,
